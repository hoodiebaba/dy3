...
class co_94_nr_nr_relation_anr(att_xml_base):
    def create_rpc_msg(self):
        ...
        del df_tr, df_nr
        df_rel[['freq', 'relid', 'ext_id', 'ext_cell_id', 'ext_cell_mo']] = \
            df_rel.apply(self.get_anr_type_mo_ids_for_rel, axis=1, result_type='expand')
