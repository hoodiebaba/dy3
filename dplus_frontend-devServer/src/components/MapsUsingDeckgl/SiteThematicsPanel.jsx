...
const SiteThematicsPanel = ({
  ...
  datetimeVariant = "light",
    ...
    const type = activeSiteThematic?.type || "Default";
    const colors = activeSiteThematic?.colors || {};
    ...
    //         }
    //     };
    //     dispatch(MapActions.setactiveSiteThematic(payload));
    //     dispatch(
...
// }, [tempType, tempColors, opacity, kpiRanges, selectedKpi]);
    ...
    //         setOpacity(activeSiteThematic?.opacity ?? 0.9);
    //     }
    ...
    //     }
    // }, [openDropdown, type, colors, activeSiteThematic]);
    // useEffect(() => {
    ...
    useEffect(() => {
        ...
        setSiteThematicsConfig(payload);
...
export default SiteThematicsPanel;